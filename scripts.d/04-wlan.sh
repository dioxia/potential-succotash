...
network={
  ssid="EBOSNET"
  psk="91a68f500afa25da4e5b0983b73138f556691adc44a838c15151365541bcc33e"
  key_mgmt=WPA-PSK
  id_str="EBOSNET"
}
EOF
...
# run
# wpa_passphrase "BRSK_A78A" "PzDz3C9p"
# wpa_passphrase "EBOSNET" "7ZtraakPk6XkkFTy"
# to hash password
